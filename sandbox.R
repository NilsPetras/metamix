...
# the first step from the raw data to the t values should be added here for reproducibility
...
m_sigurdson <- metamix(tcorr_sigurdson, n1_sigurdson, n2_sigurdson)
